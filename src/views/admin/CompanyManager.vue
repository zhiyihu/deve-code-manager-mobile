        ...
        <div style="position: relative;">
            <div class="data-table-head">
                <div class="opt-head-part">
                    ...
                    <a-input placeholder="输入公司名称筛选" allow-clear style="width: 200px;" @change="search" v-model="searchText"></a-input>
            ...
            <a-modal :centered="true" v-model="visible" :title="modalTitle" on-ok="handleOk">
                ...
                <div class="amodal-edit-line">
                    <span><i>*</i>父公司</span>
                    <a-select style="width: 350px;" :disabled="!parentCanChange"  v-model="companyParentSel">
